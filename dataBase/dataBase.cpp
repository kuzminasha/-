...
// dataBase.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CdataBaseApp

CdataBaseApp theApp;


// Инициализация CdataBaseApp
...
// Обработчики сообщений CdataBaseApp
